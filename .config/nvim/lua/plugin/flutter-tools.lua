...
return {
  ...
  keys = stream.start({
        { key = 'ww', title = 'Wrap with widget...' },
        { key = 'wb', title = 'Wrap with Builder' },
        { key = 'wc', title = 'Wrap with Column' },
        { key = 'wr', title = 'Wrap with Row' },
        { key = 'r',  title = 'Remove this widget' },
      }).map(function(def)
        return {
          '<leader>ll' .. def.key,
          function()
