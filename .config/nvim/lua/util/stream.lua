...
intermediates.reversed = {}
---@param info stream_info
function intermediates.reversed.post(info)
  local reversed = {}
  for i = #info.consumed_elements, 1, -1 do
    table.insert(reversed, info.consumed_elements[i].value)
  end
  return reversed
end
